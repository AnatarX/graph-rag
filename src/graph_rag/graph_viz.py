...
# оставлен как защита на уровне функции (не только UI) на случай датасета заметно больше
...
# resolution), так что явный потолок дешевле, чем полагаться на размер датасета.
